...
If you're using React/JSX, the HTML snippets work with a couple of attribute name changes:

- `class` → `className`
- inline `style` strings → style objects

```jsx
<a href="https://github.com/your/repo" className="github-corner" aria-label="View source on GitHub">
  <svg
    width="80"
    height="80"
    viewBox="0 0 250 250"
